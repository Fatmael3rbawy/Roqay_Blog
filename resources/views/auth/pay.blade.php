...
<main class="main-content  mt-0">
    <div class="page-header min-vh-100" style="background-image: url('../../../assets/img/curved-images/curved9.jpg');">
            ...
            <div class="card">
              <div class="card-body px-lg-5 py-lg-5 text-center">
                ...
                <div class="text-center">
                  <p class="text-muted text-sm">Please activate your email.</p>
                  <a class="btn bg-gradient-warning w-100" href="{{ $payment_url }}">Go</a>
